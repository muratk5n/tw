...
def do_syria():
    ...
    hts = get_coords_for_regex2("Armed Groups-W. Aleppo") + \
          ...
          get_coords_for_regex2("Armed Groups-S.Hasakah")
    ...
    sdf = get_coords_for_regex2("SDF-Aleppo") + \
          ...
          get_coords_for_regex2("YPG-E. Hasakah")
    ...
    sdf2 = get_coords_for_regex2("YPG-Aleppo")        
    csdf2 = create_polygon(sdf2)
    print ('sdf2',len(csdf2))    
    csdf2 = [list(x) for x in csdf2]    
    ...
    d = { "TR": [c1, c2], "HTS": chts1, "SAA": csaa, "ISR": cidf,
          "DRUZE": cdr, "SDF": csdf, "SDF2": csdf2, "ISIS": cis}
