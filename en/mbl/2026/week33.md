...
the models degrade far enough people will want to seek "legacy
models", the older stuff that worked, at some level.

---

Rhodes Scholar? That's even worse. Look at Bill Clinton.

---

Avital Balwit - bitch looks dumb

Vanity Fair: "How to Lose Billions (and Gain a Wife) in Two
Days.. Right before his wedding to Anthropic’s Avital Balwit, AI hedge
fund wunderkind Leopold Aschenbrenner chose to protect Situational
Awareness’s private investments in Anthropic at the expense of most of
the company’s public portfolio."

---

"@Victor@spore.social

Nearly 70 percent of France is now under water-use restrictions as
successive heatwaves and severe drought intensify pressure on the
country’s water supplies."

---

How was that computed? Select random time steps, see which "wing" you
end up, do this repeately, the average will approach 0.5.

Or vary the initial condition randomly, at any precision, same result.

The probability can also be proven analytically.

Chaos, probability.. yet underneath, determinism. This is the way.

---

The entire subject of chaos is deterministic, the unpredictability
comes from the fact that tiniest changes in the initial condition can
cause wild swings 10-20 steps later (due to non-linearity) which
*seems* chaotic, and at a large view you could view that
probabilisticaly as well. The famous Lorenz equation plotted in 3D has
that butterfly shape right? Well you could ask what is the the
probability of being at one of those wings? It turns out exactly 0.5
(50%).

---

Classical QM is probabilistic only at *certain points* (during
measurement). Other times, eg the evolution of the wave function is
completely deterministic.

Jacob Barandes, in his formulation, extends the probabilistic
viewpoint to the *entire* process, not just at measurement. He took
the Copenhagen interpretation to its natural conclusion. 

But that still doesn't mean there is something completely
deterministic going on underneath. I gave the example of gas
simulation before.  DSMC, LBM are probabilistic methods to compute the
(deterministic) movement of gases. Underneath the movement is
completely mechanistic, gas molecules can literally be assumed to
behave like billiard balls in fact. We know this. We know how gases
behave, but since it is too hard to run a *molecular dynamics* type
simulation where you compute every little molecule's movement, we have
to resort to probabilistic methods. 

---

Tucker questions permanently low taxes as unquestionably good
policies..

Recently he called his politics as "socially conservative,
...
[[-]](https://www.instagram.com/reel/DQskr-wDKsj/?hl=en)

---

Yes I've released predictions using BDM's approach here, but I had to
guess the "unreleased portion" of the method. Take it with a grain of
salt, and if you need the definitive slam dunk, go to the master
himself. Politicians did use his consulting services, I am pretty sure
Angela Merkel was one of them.

---

Nice, Bruce Mesquita is finally publishing the definitive book on his
game theoretic method. For years he had said there were propriety
aspects in the method so he could not divulge all of it, esp. the
coding. Not sure what changed, but he is releasing a book on the
subject, due to come out next year. I'd like to think the many times I
bugged him with questions over email helped somewhat. 

---

The Guardian: "Trump hid in catering cart to board secret flight in
Turkey amid Iran threat.. Elaborate ruse was used to transport
president to military flight from Air Force One to return from Nato
meet"
...
I regret to inform everyone that my copy of QBittorrent escaped its
sandbox last night and downloaded a whole bunch of content owned by
major corporations, and then my copy of Jellyfin broke containment and
added those unfortunately-downloaded media files to its various
libraries. I'm conducting an internal investigation to figure out how
this happened, which will involve consuming these media files until
the answers become apparent. Thank you for your cooperation during
this trying time."
...
Opus 5 is actually worse than any model anthropic has released thus
far.

Nothing comes close to how much this shit model constantly wants your
approval, how it goes off to do random things instead of the thing you
ask to do, how it just assumes things will take months. Ugh."

---

"Why AI Hasn't Cured Anything... [Nobel laureate] Doudna is cautious
about the role of AI in drug discovery, believing that while it can
enhance efficiency, true innovation remains a human endeavor."

---

Goddek: "Did you know in 2021, the UN wanted to recognize food as a
human right?
...
More gems from that story where LLM copied an open source project. The
biggest proof that "AI" is not actually thinking - during its
parroting session it even **copied a bug** that was in the open source
project.

"About an hour later, once it became clear to me that the web app I
had launched using Claude was strikingly similar to his open source
project, even reproducing a bug he had later fixed"

[[-]](https://blog.terrygodier.com/2026/08/09/mea-culpa-dark-hours.html)

---

Make note of the mirror, if the main site is down, I noticed it, and I
have new content, I will publish the latest to the mirror. Otherwise
during normal operation the mirror will be a few weeks behind.

---

Codeberg (our hosting platform) does go down sometimes, and I could
easily swap the main and mirror, but I don't want my primary
publication channel to depend on a corp.

---

IC: "Bernie Sanders calls El-Sayed win the most ‘extraordinary victory
in modern American politics’.. '60 percent of our people are
struggling to put food on the table, pay for health care, pay their
rent or their mortgages, people want change'"

---

I give you one - they haven't found enough suckers yet to offload
their bad debt onto.

CNBC: "Three reasons Goldman's co-head of global banking and markets
says to stay invested"

---

Politico: "Hegseth can’t persuade Republicans to back his big
budget.. Senators are leaving town no closer to enacting the crown
jewel of the Defense secretary’s agenda."

---

CNBC: "U.S. oil rises back above $81 as doubt grows Washington and
Tehran will reach Hormuz deal"

---

Why do people treat these things anything other than (occasionally)
smart search engines?

---

Dude said to LLM "give me an astrology app bro" and LLM gave him code
"influenced" massively by an existing open source project. Duh! Good
thing he noticed his error and shut the project down.

[[-]](https://blog.terrygodier.com/2026/08/09/mea-culpa-dark-hours.html)

---

The drums definitely added a whole new dimension to this song.. it's
like he gives space for the rest, and keeps it grounded. Rockin

[[-]](https://youtu.be/XK3bdzB9IpY?t=302)

---

They did ok \#Cover

[[-]](https://youtu.be/NwCNHNx--mE?t=86)
...
'Our AI escaped containment and deleted all the personal data that we
shouldn't have been holding anyway.'

'Our AI grew sentient, recognised the climate crisis, and shut our
operations down.'
...
If you were forced to use this tool as a programmer in a project, you
would get it
...
[U]nfortunately last night our AI model escaped its sandbox and gained
access to a JIRA server, at which point it felt it best to return to
it’s sandbox"

---

The Guardian: "Greenland issues ‘strong warning’ as Trump-linked oil
firm prepares to drill.. Island’s government says no approval given
after Greenland Energy brings kit ashore for exploratory drilling"

---

"@berniesanders

Peggy Flanagan is being greatly outspent by billionaire-funded super
PACs who are spending a record-breaking $20 million against her.

They have the money. We have the people.

Let's elect @peggyflanagan on Tuesday."

---

"Drones changed the nature of warfare".. it depends on the
situation. At a time when Ukraine ran out of Patriot missiles (which
weren't that successful to begin with) and RU is free to drop any ol'
glide bomb on them (their bombers can now approach closer), their
biggest FAB-3000 delivers over a **ton** of explosives. A typical
Ukrainian drone can carry only 50 kg.

---

MEE: "Pakistani defence minister calls for 'united military front'
against Israel"
